...
int Game::showMap(sf::RenderWindow &window) {
    sf::RectangleShape rectangleShape(sf::Vector2f(size_of_cell - 1, size_of_cell - 1));
...
//        return EXIT_FAILURE;
    ...
    wallSprite.setTextureRect(sf::IntRect(32, 0, 64, 32));
...
//                rectangleShape1.setPosition((*i).getPoint().x * size_of_cell, (*i).getPoint().y * size_of_cell);
